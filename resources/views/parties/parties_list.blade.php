    ...
    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
      <div class="card-header flex-column flex-md-row">
        <div class="head-label text-center">
          <h2 class="card-title mb-0">All Parties</h2>
        </div>
        <div class="dt-action-buttons text-end pt-6 pt-md-0">
          <div class="dt-buttons flex-wrap">
          <a href="{{ route('parties.create') }}" class="btn btn-primary create-new waves-effect waves-light btn-dark rounded" 
    ...
    <script>
      ...
      $(document).ready(function () {
        ...
        $(document).on('click', '.set-btn', function () {
          ...
          $.ajax({
            ...
            success: function (response) {
              ...
              var createUrl = '{{ route('createlist', ['party_id' => ':party_id']) }}';
        ...
        $('#setPartyForm').on('submit', function (event) {
          ...
          // Construct the URL
          var url = '{{ route('lists.addcartproduct', ['list' => 'LIST_ID', 'party' => 'PARTY_ID']) }}';
