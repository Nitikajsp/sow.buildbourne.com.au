                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ old('name', $party->name) }}" class="form-control border border-white-50" placeholder="Name">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" value="{{ old('phone', $party->phone) }}" class="form-control border border-white-50" placeholder="Phone">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" value="{{ old('email', $party->email) }}" class="form-control border border-white-50" placeholder="Email">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="street" value="{{ old('street', $party->street) }}" class="form-control border border-white-50" placeholder="Street">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <!-- <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="suburb" value="{{ old('suburb', $party->suburb) }}" class="form-control border border-white-50" placeholder="Suburb">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                        ...
                        <div class="pull-right mt-1 text-center">
                            ...
                            <a class="btn btn-outline-dark waves-effect rounded" href="{{ route('parties.index') }}">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
