<aside class="sidebar">
  ...
  <ul class="menu-inner align-items-center">
    ...
    <li class="nav-item {{ request()->routeIs('parties.index') ? 'active' : '' }}">
      <a href="{{ route('parties.index') }}" class="customnav-link d-flex flex-column align-items-center text-white">
        <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
          <path stroke="none" d="M0 0h24v24H0z" fill="none" />
    ...
    <li class="nav-item {{ request()->routeIs('workgroup.showworkgroup') ? 'active' : '' }}">
      <a href="{{ route('workgroup.showworkgroup') }}" class="customnav-link d-flex flex-column align-items-center text-white">
        <!-- SVG Icon -->
        <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
          <path stroke="none" d="M0 0h24v24H0z" fill="none" />
    ...
    <li class="nav-item {{ request()->routeIs('workgroup.showgroupquestion') ? 'active' : '' }}">
      <a href="{{ route('workgroup.showgroupquestion') }}" class="customnav-link d-flex flex-column align-items-center text-white">
        <!-- SVG Icon -->
        <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
          <path stroke="none" d="M0 0h24v24H0z" fill="none" />
          <path d="M3 9a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v9a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2v-9z" />
