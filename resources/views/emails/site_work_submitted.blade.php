...
.container-partylist {
    ...
    justify-content: flex-end; */
        ...
        /* Conditional 'If by builder' Sections */
        .buildr-details {
            padding: 15px 20px;
            background-color: #f8f9fa;
        ...
        .buildr-details label {
            font-weight: 500;
            font-size: 15px;
            margin-bottom: 12px;
        }

        .buildr-details .formbuilder-radio-inline label {
            margin-bottom: 0px;
        }

        /* Hide on page load (if required) */
        .buildr-details[style*="display: none"] {
            display: none !important;
        }


        .formbuilder-radio-group.form-group.responsible-party {
            display: flex;
        ...
        .formbuilder-radio-group.responsible-party .formbuilder-radio-inline {
            display: inline-flex;
            flex-direction: column;
            align-items: center;
            margin-right: 0px;
        ...
        .formbuilder-radio-group.responsible-party label {
            font-family: "Inter-Medium", sans-serif;
            font-weight: 500;
            font-size: 16px;
            line-height: 26px;
        ...
        .formbuilder-radio-group.responsible-party .formbuilder-radio-inline label {
            font-size: 12px;
            line-height: 16px;
        }

        .formbuilder-radio-group.responsible-party .formbuilder-radio-inline input[type="radio"] {
            margin-right: 0px;
        }

        .buildr-details .formbuilder-radio-inline input[type="radio"] {
            margin-right: 10px;
        }

        .rendered-form.formbuilder-embedded-bootstrap textarea {
            border: 1px dashed #AFB691;
            min-height: 100px;
            width: 100%;
            height: 100%;
        }
...
<body>
    ...
    <div class="form-group">
        <div class="formbuilder-radio-group form-group field-radio-group-1745578098316 responsible-party"><label for="radio-group-1745578098316" class="formbuilder-radio-group-label">{{ strip_tags($field['label'] ?? 'Unnamed Field') }}<span class="formbuilder-required">*</span></label>
            <div class="radio-group">
                <div class="formbuilder-radio-inline"><input class="responsible-party" name="radio-group-1745578098316" access="false" user-data="N/A" id="radio-group-1745578098316-0" aria-required="true" value="By Builder" type="radio"><label for="radio-group-1745578098316-0">By Builder</label></div>
                <div class="formbuilder-radio-inline"><input class="responsible-party" name="radio-group-1745578098316" access="false" user-data="N/A" id="radio-group-1745578098316-1" aria-required="true" value="By Owner" type="radio"><label for="radio-group-1745578098316-1">By Owner</label></div>
                <div class="formbuilder-radio-inline"><input class="responsible-party" name="radio-group-1745578098316" access="false" user-data="N/A" id="radio-group-1745578098316-2" aria-required="true" value="N/A" type="radio"><label for="radio-group-1745578098316-2">N/A</label></div>
                <div class="formbuilder-radio-inline"><input class="responsible-party other-option" name="radio-group-1745578098316" access="false" user-data="N/A" id="radio-group-1745578098316-other" aria-required="true" value="" type="radio"><label for="radio-group-1745578098316-other">Other<input type="text" id="radio-group-1745578098316-other-value" class="other-val"></label></div>
            </div>
        </div>
