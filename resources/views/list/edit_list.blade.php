                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="suburb" value="{{ old('suburb', $list->suburb) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="state" class="form-control border border-white-50">
                                                <option value="New South Wales (NSW)"
                                                    {{ old('state', $list->state) == 'New South Wales (NSW)' ? 'selected' : '' }}>
                                                    New South Wales (NSW)</option>
                                                <option value="Victoria (VIC)"
                                                    {{ old('state', $list->state) == 'Victoria (VIC)' ? 'selected' : '' }}>
                                                    Victoria (VIC)</option>
                                                <option value="Queensland (QLD)"
                                                    {{ old('state', $list->state) == 'Queensland (QLD)' ? 'selected' : '' }}>
                                                    Queensland (QLD)</option>
                                                <option value="Western Australia (WA)"
                                                    {{ old('state', $list->state) == 'Western Australia (WA)' ? 'selected' : '' }}>
                                                    Western Australia (WA)</option>
                                                <option value="South Australia (SA)"
                                                    {{ old('state', $list->state) == 'South Australia (SA)' ? 'selected' : '' }}>
                                                    South Australia (SA)</option>
                                                <option value="Tasmania (TAS)"
                                                    {{ old('state', $list->state) == 'Tasmania (TAS)' ? 'selected' : '' }}>
                                                    Tasmania (TAS)</option>
                                                <option value="Australian Capital Territory (ACT)"
                                                    {{ old('state', $list->state) == 'Australian Capital Territory (ACT)' ? 'selected' : '' }}>
                                                    Australian Capital Territory (ACT)</option>
                                                <option value="Northern Territory (NT)"
                                                    {{ old('state', $list->state) == 'Northern Territory (NT)' ? 'selected' : '' }}>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="pincode"
                                                value="{{ old('pincode', $list->pincode) }}"
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control border border-white-50"
                                                style="height:150px !important;" name="description"
                                            ...
                                            <div class="input-group">
                                                <select id="status" name="status" class="form-select">
                                                    ...
                                                    <option value="Pending"
                                                        {{ $list->status == 'Pending' ? 'selected' : '' }}>Pending
                                                    </option>
                                                    <option value="In Progress"
                                                        {{ $list->status == 'In Progress' ? 'selected' : '' }}>In
                                                        Progress</option>
                                                    <option value="Completed"
                                                        {{ $list->status == 'Completed' ? 'selected' : '' }}>Completed
                                                    </option>
                                                </select>
                                            </div>
