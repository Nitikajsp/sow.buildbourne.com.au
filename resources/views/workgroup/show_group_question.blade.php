                        ...
                        <div class="partyscroll">
                            <table class="table datatables-projects" id="partylist">
                                ...
                                <tbody class="">
                                            ...
                                            <div class="d-flex justify-content-center align-items-center">
                                                <div class="d-inline-block">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end m-0">
                                                        <a href="{{ route('workgroup.workgroupquestionedit', $workgroupquestion->id) }}"
                                                            class="btn p-0 edit-btn dropdown-item">
                                                            <i class="ti ti-pencil me-1"></i> Edit
                                                        </a>
                                                        <a href="{{ route('workgroup.workquestionview', $workgroupquestion->id) }}"
                                                            class="btn p-0 view-btn dropdown-item">
                                                            <i class="ti ti-eye me-1"></i> View
                                                        </a>
                                                        <div class="dropdown-divider"></div>
                                                        <form id="deletePartyForm"
                                                            action="{{ route('workgroup.workquestiondelete', $workgroupquestion->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="button"
                                                                class="btn p-0 delete-btn text-danger dropdown-item"
                                                                data-party-id="{{ $workgroupquestion->id }}"
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="5" class="text-center text-muted">No group questions available.
                                        </td>
                                    </tr>
                                    @endforelse
