    ...
    <div class="container">
        ...
        <div class="container mt-5">
            <div class="inner-container custmrmt0">
                ...
                <form action="{{ route('workgroup.workgroupquestionupdate', $workgroupquestion->id) }}" method="POST" id="editPartyForm">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="question_title" value="{{ old('question_title', $workgroupquestion->question_title) }}" class="form-control border border-white-50" placeholder="Question Title">
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="form-group">
                                <p class="text-secondary mb-1">Question Value</p>
                                <input type="text" name="question_value" value="{{ old('question_value', $workgroupquestion->question_value) }}" class="form-control border border-white-50" placeholder="Question Value">
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
