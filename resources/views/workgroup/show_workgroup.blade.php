            ...
            <div class="card-header flex-column flex-md-row">
                ...
                <div class="dt-action-buttons text-end pt-6 pt-md-0">
                    <div class="dt-buttons flex-wrap">
                        <a href="{{ route('workgroup.addworkgroup') }}" class="btn btn-primary create-new waves-effect waves-light btn-dark rounded" tabindex="0" aria-controls="DataTables_Table_0">
                                ...
                                <td class="d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="d-inline-block">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end m-0">
                                            <a href="{{ route('workgroup.workgroupedit', $workgroup->id) }}" class="btn p-0 edit-btn dropdown-item">
                                                <i class="ti ti-pencil me-1"></i> Edit
                                            </a>
                                            <a href="{{ route('workgroup.workgroupview', $workgroup->id) }}" class="btn p-0 view-btn dropdown-item">
                                                <i class="ti ti-eye me-1"></i> View
                                            </a>

                                            <div class="dropdown-divider"></div>
                                            <form id="deletePartyForm" action="{{ route('workgroup.workgroupdelete', $workgroup->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" class="btn p-0 delete-btn text-danger dropdown-item" data-party-id="{{ $workgroup->id }}" data-bs-toggle="modal" data-bs-target="#deleteModal">
