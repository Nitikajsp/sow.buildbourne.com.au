            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="inner-container ">
                        ...
                        <form action="{{ route('workgroup.workgroupupdate', $workgroup->id) }}" method="POST"
                            id="editPartyForm">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="group_name"
                                            value="{{ old('group_name', $workgroup->group_name) }}"
                                            class="form-control border border-white-50" placeholder="Group Name">
                                ...
                                <div class="pull-right mt-1 text-center">
                                    ...
                                    <a class="btn btn-outline-dark waves-effect rounded"
                                        href="{{ route('workgroup.showworkgroup') }}">Cancel</a>
                                </div>
                        </form>
                    </div>
                </div>
