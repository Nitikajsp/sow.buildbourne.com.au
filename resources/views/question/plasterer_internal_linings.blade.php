<div class="card p-3 mb-3">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sow[plasterer_and_internal_linings][standard_insulation]" id="standard_insulation" value="standard_insulation" checked>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            ...
            <input type="text" name="sow[plasterer_and_internal_linings][additional_insulation_type]" class="form-control" placeholder="Type">
        </div>
...
<div class="card p-3 mb-3">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sow[plasterer_and_internal_linings][standard_plasterboard]" id="standard_plasterboard" value="standard_plasterboard" checked>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <div class="form-check">
                <input class="form-check-input" type="radio" name="sow[plasterer_and_internal_linings][ceiling_cornice_type]" id="standard_cove" value="standard_cove" checked>
            ...
            <input type="text" name="sow[plasterer_and_internal_linings][ceiling_cornice_type_text]" class="form-control" placeholder="Type/s">
        </div>
    </div>
...
<div class="card p-3 mb-3">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sow[plasterer_and_internal_linings][bulk_heads]" id="bulk_heads" value="bulk_heads" checked>
                <label class="form-check-label" for="bulk_heads"></label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sow[plasterer_and_internal_linings][bulk_heads]" id="bulk_heads_na" value="na">
    ...
    <div class="form-group">
        <label>Notes to above:</label>
        <textarea name="sow[plasterer_and_internal_linings][notes_above_bulk_heads]" class="form-control">BULKHEADS TO KITCHENS</textarea>
    </div>
