    ...
    <div class="form-group row">
        <div class="col-sm-12">
            <div class="form-check">
                <input class="form-check-input" type="radio" name="sow[electrician][power_into_property_price]" id="fixed_10mtrs" value="fixed_10mtrs" checked>
...
<div class="card p-3 mb-3">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="sow[electrician][connection_type]" id="fixed_builder_type" value="fixed_builder" checked>
