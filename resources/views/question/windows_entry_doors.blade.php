...
<div class="card pdf-card mb-3">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="form-check align-items-center form-check-inline">
                    <input class="form-check-input" type="radio" id="hume_doors" name="door_manufacturer"
                        value="Hume Doors">
                    <label class="form-check-label" for="hume_doors">Hume Doors</label>
                </div>
                <span class="mx-2">OR</span>
                <div class="form-check align-items-center form-check-inline">
                    <input class="form-check-input" type="radio" id="other_doors" name="door_manufacturer"
                        value="Other">
        ...
        <div class="mb-3">
            ...
            <div class="mb-2">
                <div class="row align-items-center ">
                    <div class="col-sm-2"> <label>- Entry door</label></div>
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center gap-2">
                            <div class="form-check align-items-center form-check-inline ms-3">
                                <input class="form-check-input" type="radio" name="entry_door_selected" value="Yes">
                            </div>
                            <div class="w-100">
                                <div class="d-flex gap-2 w-100">
                                    <span class="ms-3 w-25">Type:</span>
                                    <input type="text" class="form-control d-block w-100  mx-2" name="entry_door_type">
                                </div>
                                <div class="d-flex gap-2">

                                    <span class="ms-3 w-25">Glass:</span>
                                    <input type="text" class="form-control d-block w-100  mx-2" name="entry_door_glass"
                                        placeholder="e.g., OBSCURE">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="w-100">
                                <div class="d-flex gap-2 w-100">
                                    <span class="ms-3 w-25">Type:</span>
                                    <input type="text" class="form-control d-block w-100 mx-2" name="side_lights_type">
                                </div>
                                <div class="d-flex gap-2">
                                    <span class="ms-3 w-25">Glass:</span>
                                    <input type="text" class="form-control d-block w-100 mx-2" name="side_lights_glass">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="w-100">
                                <div class="d-flex gap-2 w-100">
                                    <span class="ms-3 w-25">Type:</span>
                                    <input type="text" class="form-control d-block w-100 mx-2" name="laundry_door_type"
                                        value="SLIDER">
                                </div>
                                <div class="d-flex gap-2">
                                    <span class="ms-3 w-25">Glass:</span>
                                    <input type="text" class="form-control d-block w-100 mx-2"
                                        name="laundry_door_glass">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="w-100">
                                <div class="d-flex gap-2 w-100">
                                    <span class="ms-3 w-25">Type:</span>
                                    <input type="text" class="form-control d-block w-100 mx-2" name="garage_pa_type">
                                </div>
                                <div class="d-flex gap-2">
                                    <span class="ms-3 w-25">Glass:</span>
                                    <input type="text" class="form-control d-block w-100 mx-2" name="garage_pa_glass">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mb-2">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6">
                        <div class="d-flex align-items-center gap-2">
                            <div class="form-check align-items-center form-check-inline ms-3">
                                <input class="form-check-input" type="radio" name="other_hinged_entry_selected"
                                    value="Yes">
                            </div>
                            <div class="w-100">
                                <div class="d-flex gap-2 w-100">
                                    <span class="ms-3 w-25">Type:</span>
                                    <input type="text" class="form-control d-block w-100 mx-2"
                                        name="other_hinged_entry_type">
                                </div>
                                <div class="d-flex gap-2">
                                    <span class="ms-3 w-25">Glass:</span>
                                    <input type="text" class="form-control d-block w-100 mx-2"
                                        name="other_hinged_entry_glass">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Hinges -->
        <div class="mb-3">
            <label class="mb-2"><strong>- Hinges as applicable:</strong></label><br>
            <div class="form-check align-items-center form-check-inline">
...
<div class="card pdf-card mb-3">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <div class="form-check align-items-center form-check-inline mt-2">
...
<div class="card pdf-card mb-3">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5>8.3 Windows & Door Units / Sliders</h5>
    </div>
    <div class="card-body">
            ...
            <div class="col-sm-9">
                <div class="form-check d-flex align-items-center gap-2">
                    <input class="form-check-input" type="radio"
                        name="sow[windows_and_entry_doors][aluminium_door_units]" value="door_units">
                    <label class="form-check-label">Door units <span class="text-success"
                            style="font-size: 1.5em;"></span></label>
                </div>
                <div class="form-check d-flex align-items-center gap-2">
                    <input class="form-check-input" type="radio"
                        name="sow[windows_and_entry_doors][aluminium_door_units]" value="sliding_doors">
                    <label class="form-check-label">Sliding doors <span class="text-success"
                            style="font-size: 1.5em;"></span></label>
                </div>
                <div class="form-check d-flex align-items-center gap-2">
                    <input class="form-check-input" type="radio"
                        name="sow[windows_and_entry_doors][aluminium_door_units]" value="windows">
                    <label class="form-check-label">Windows <span class="text-success"
                            style="font-size: 1.5em;"></span></label>
                </div>
        ...
        <div class="form-group row mb-4">
            ...
            <div class="col-sm-9">
                <div class="d-flex gap-2">
                    <div class="form-check align-items-center gap-2 form-check-inline flex-shrink-0">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][aluminium_sliding]" value="sliding">
                        <label class="form-check-label">Sliding</label>
                    </div>
                    <div class="form-check align-items-center gap-2 form-check-inline flex-shrink-0">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][aluminium_sliding]" value="double_hung">
                        <label class="form-check-label">Double hung</label>
                    </div>
                    <div class="form-check align-items-center gap-2 form-check-inline flex-shrink-0">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][aluminium_sliding]" value="other">
        ...
        <div class="form-group row mb-4">
            ...
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-check d-flex align-items-center gap-2">
                            <input class="form-check-input" type="radio"
                                name="sow[windows_and_entry_doors][timber_door_units]" value="door_units">
                            <label class="form-check-label">Door units <br>
                            </label>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-check d-flex align-items-center gap-2">
                            <input class="form-check-input" type="radio"
                                name="sow[windows_and_entry_doors][timber_door_units]" value="na"> N/A <span
                                class="text-success" style="font-size: 1.5em;"></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-check d-flex align-items-center gap-2">
                            <input class="form-check-input" type="radio"
                                name="sow[windows_and_entry_doors][timber_sliding_doors]" value="sliding_doors">
                            <label class="form-check-label">Sliding doors <br>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-check d-flex align-items-center gap-2">
                            <input class="form-check-input" type="radio"
                                name="sow[windows_and_entry_doors][timber_sliding_doors]" value="na"> N/A <span
                                class="text-success" style="font-size: 1.5em;"></span></label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-check d-flex align-items-center gap-2">
                            <input class="form-check-input" type="radio"
                                name="sow[windows_and_entry_doors][timber_sliding_doors]" value="windows">
                            <label class="form-check-label">Windows <br>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-check d-flex align-items-center gap-2">
            ...
            <div class="form-group row mt-3">
                ...
                <div class="col-sm-9">
                    <div class="form-check align-items-center form-check-inline">
                        <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][timber_sliding]"
                            value="sliding">
                        <label class="form-check-label">Sliding</label>
                    </div>
                    <div class="form-check align-items-center form-check-inline">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="form-check align-items-center form-check-inline">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][window_locks_keyed_alike]" value="yes">
                        <label class="form-check-label">Yes</label>
                    </div>
                    <div class="form-check align-items-center form-check-inline">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][window_locks_keyed_alike]" value="no">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="form-check align-items-center form-check-inline">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][door_units_keyed_alike]" value="yes">
                        <label class="form-check-label">Yes</label>
                    </div>
                    <div class="form-check align-items-center form-check-inline">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][door_units_keyed_alike]" value="no">
                        <label class="form-check-label">No</label>
                    </div>
                </div>
            </div>
            ...
            <div class="font-italic small mt-3">
                <span class="font-weight-bold" style="font-style: normal;">Note:</span> Generally timber entry doors,
                door
                units
                and windows CANNOT be ALL keyed alike as a group.
            </div>

            <div class="form-group row">
                <label class="col-sm-12">All double door units and sliding door units to indicate active leaf on
                    plan</label>
                <div class="col-sm-12">
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][double_door_active_leaf]" value="active_leaf">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12">
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][standard_preprimed_reveals]" value="preprimed">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12">
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][meranti_reveals]" value="meranti">
                    </div>
                </div>
            </div>
            <div class="form-group row">
    ...
    <div class="card pdf-card mb-3">
        ...
        <div class="card-body">
            ...
            <div class="font-italic small mt-3">
                <span class="font-weight-bold" style="font-style: normal;">Note:</span> Unless otherwise specified
                below,
                ALL
                windows and door unit glass will be clear glazed with the exception of WC's, Bathrooms and Ensuites
                which
                will
                be obscure glass.
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="form-check align-items-center form-check-inline">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][glazing_requirements]" id="glazing_yes" value="yes">
                        <label class="form-check-label" for="glazing_yes">Yes</label>
                    </div>
                    <div class="form-check align-items-center form-check-inline">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][glazing_requirements]" id="glazing_no" value="no">
            ...
            <div class="form-group row">
                <label class="col-sm-3 col-form-label">-Location:
                    <input type="text" name="sow[windows_and_entry_doors][location1]" class="form-control"
                        value="FRONT ENTRANCE TO BOTH UNITS">
                </label>
                <div class="col-sm-9">
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][glazing_type1]"
                            id="clear1" value="clear">
                        <label class="form-check-label" for="clear1">Clear glass</label>
                    </div>
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][glazing_type1]"
                            id="obscure1" value="obscure" checked>
                        <label class="form-check-label" for="obscure1">Obscure glass</label>
                    </div>
                    <div class="form-check d-flex align-items-center">
                        <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][glazing_type1]"
                            id="other1" value="other">
                        <label class="form-check-label mr-2" for="other1">Other</label>
                        <input type="text" name="sow[windows_and_entry_doors][glazing_type1_other]" id="otherText1"
                            class="form-control form-control-sm w-50 ml-2" placeholder="Please specify...">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][glazing_type2]"
                            id="clear2" value="clear">
                        <label class="form-check-label" for="clear2">Clear glass</label>
                    </div>
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][glazing_type2]"
                            id="obscure2" value="obscure">
                        <label class="form-check-label" for="obscure2">Obscure glass</label>
                    </div>
                    <div class="form-check d-flex align-items-center">
                        <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][glazing_type2]"
                            id="other2" value="other">
                        <label class="form-check-label mr-2" for="other2">Other</label>
                        <input type="text" name="sow[windows_and_entry_doors][glazing_type2_other]" id="otherText2"
                            class="form-control form-control-sm w-50 ml-2" placeholder="Please specify...">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][glazing_type3]"
                            id="clear3" value="clear">
                        <label class="form-check-label" for="clear3">Clear glass</label>
                    </div>
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][glazing_type3]"
                            id="obscure3" value="obscure">
                        <label class="form-check-label" for="obscure3">Obscure glass</label>
                    </div>
                    <div class="form-check d-flex align-items-center">
                        <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][glazing_type3]"
                            id="other3" value="other">
                        <label class="form-check-label mr-2" for="other3">Other</label>
                        <input type="text" name="sow[windows_and_entry_doors][glazing_type3_other]" id="otherText3"
                            class="form-control form-control-sm w-50 ml-2" placeholder="Please specify...">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][glazing_type4]"
                            id="clear4" value="clear">
                        <label class="form-check-label" for="clear4">Clear glass</label>
                    </div>
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][glazing_type4]"
                            id="obscure4" value="obscure">
                        <label class="form-check-label" for="obscure4">Obscure glass</label>
                    </div>
                    <div class="form-check d-flex align-items-center">
                        <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][glazing_type4]"
                            id="other4" value="other">
                        <label class="form-check-label mr-2" for="other4">Other</label>
                        <input type="text" name="sow[windows_and_entry_doors][glazing_type4_other]" id="otherText4"
                            class="form-control form-control-sm w-50 ml-2" placeholder="Please specify...">
                    </div>
                </div>
            </div>
    ...
    <div class="card pdf-card mb-3">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio" id="fibreglass"
                            name="sow[windows_and_entry_doors][flyscreen_type]" value="fibreglass" checked>
                        <label class="form-check-label" for="fibreglass">Standard fibreglass mesh</label>
                    </div>
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio" id="steel"
                            name="sow[windows_and_entry_doors][flyscreen_type]" value="steel">
                        <label class="form-check-label" for="steel">Stainless steel mesh (@ Extra Cost) <span
                                class="small text-muted">Suitable for fire regulations</span></label>
                    </div>
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio" id="other"
                            name="sow[windows_and_entry_doors][flyscreen_type]" value="other">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="form-check align-items-center form-check-inline">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][security_door_price]" value="fixed">
                        <label class="form-check-label">Per Selections Below</label>
                    </div>
                    <div class="form-check align-items-center form-check-inline">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][security_door_price]" value="na">
                        <label class="form-check-label">N/A</label>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][security_door_sum]" value="provisional">
            ...
            <div class="form-group row">
                <label class="col-sm-3 col-form-label">- Security grille standard pattern: (Fitted to Sliding Doors with
                    Deadlocks)</label>
                <div class="col-sm-9">
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio" id="vinyl"
                            name="sow[windows_and_entry_doors][security_grille_pattern]" value="vinyl">
                        <label class="form-check-label" for="vinyl">Vinyl mesh</label>
                    </div>
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio" id="stainless"
                            name="sow[windows_and_entry_doors][security_grille_pattern]" value="stainless">
                        <label class="form-check-label" for="stainless">Stainless steel mesh <span
                                class="small text-muted">Suitable for fire regulations</span></label>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" name="sow[windows_and_entry_doors][security_door_supplier]"
                        class="form-control mb-2" placeholder="Supplier">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <textarea name="sow[windows_and_entry_doors][security_door_entries]"
        ...
        <div class="card-body">
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-9">
                    <div class="form-check align-items-center form-check-inline">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][window_shutter_price]" value="fixed">
                        <label class="form-check-label">Per Quote Attached</label>
                    </div>
                    <div class="form-check align-items-center form-check-inline">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][window_shutter_price]" value="na">
                        <label class="form-check-label">N/A</label>
                    </div>
                </div>
            </div>
            <div class="form-group row ">
                <div class="col-sm-2">- If by builder:</div>
                <label class="col-sm-3 col-form-label"> 1) Fixed price included in quote</label>
                <div class="col-sm-7">
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][window_shutter_price]" value="fixed">
            ...
            <div class="form-group row">
                ...
                <label class="col-sm-3 col-form-label">2) Provisional Sum</label>
                <div class="col-sm-7">
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][window_shutter_sum]" value="provisional">
            ...
            <div class="form-group row mt-3">
                <label class="col-sm-3 col-form-label">- Selection:</label>
                <div class="col-sm-9">
                    <input type="text" name="sow[windows_and_entry_doors][window_shutter_supplier]"
                        class="form-control mb-2" placeholder="Supplier">
    ...
    <div class="card pdf-card mb-3">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="radiobuttons-wrap">
                <label class="me-3">As shown on plans
                    <input type="radio" name="sow[windows_and_entry_doors][garage_doors]" value="builder"
                        class="form-check-input">
                </label>

                <label>N/A
                    <input type="radio" name="sow[windows_and_entry_doors][garage_doors]" value="na"
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][door_type]"
                            id="roller" value="roller">
                        <label class="form-check-label" for="roller">Roller door</label>
                    </div>
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][door_type]"
                            id="panel" value="panel" checked>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" name="sow[windows_and_entry_doors][style_1]" class="form-control"
                        value="MADISON">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" name="sow[windows_and_entry_doors][supplier_2]" class="form-control"
                        value="HVGO">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" name="sow[windows_and_entry_doors][colorbond_colour_1]" class="form-control"
                        value="Woodlands Grey">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Colorbond Colour:</label>
                        <div class="col-sm-9">
                            <input type="text" name="sow[windows_and_entry_doors][colorbond_colour]"
                                class="form-control" value="Woodlands Grey">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Supplier:</label>
                    ...
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][wood_grain]"
                            id="wood_grain" value="wood_grain" checked>
                        <label class="form-check-label" for="wood_grain">Wood grain</label>
                    </div>
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][other]"
                            id="other" value="other">
                        <label class="form-check-label" for="other">Other</label>
                        <input type="text" class="form-control form-control-sm w-75 border-0 border-bottom"
                            name="sow[site_work][garage_doors_other_note]" id="garage_doors_other_note"
                            placeholder="Enter garage doors notes">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][motorised_openings]" id="all_doors" value="all_doors"
                            checked>
                        <label class="form-check-label" for="all_doors">All garage doors</label>
                    </div>
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][motorised_openings]" id="listed_doors"
                            value="listed_doors">
                    ...
                    <div><input type="text" class="form-control form-control-sm w-75 border-0 border-bottom"
                            name="sow[site_work][garage_doors_other_note]" id="garage_doors_other_note"
                            placeholder="Enter garage doors notes"></div>
                    <div><input type="text" class="form-control form-control-sm w-75 border-0 border-bottom"
                            name="sow[site_work][garage_doors_other_note]" id="garage_doors_other_note"
                            placeholder="Enter garage doors notes"></div>
                </div>
            </div>
            <div class="p-3 mt-4 text-white"
                style="background: linear-gradient(to right, #cc5200, #ff6600); border: 2px solid #000;">
                ...
                <div class="mt-2">
                    <strong>Checked By:</strong> <input type="text" class="form-control d-inline-block ml-1"
                        style="width: 200px;" placeholder="Signature or Name" readonly>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <div class="form-check d-flex align-items-center gap-2">
                        <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][checked]"
                            id="checked" value="checked" checked>
