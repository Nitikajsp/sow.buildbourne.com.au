    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            ...
            <div class="mb-2">
                ...
                <span>Glass:</span>
                <input type="text" class="form-control d-inline-block w-25 mx-2" name="entry_door_glass"
...
<div class="card pdf-card mb-3">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][aluminium_sliding]"
                        value="sliding">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][timber_door_units]"
                        value="door_units">
                    <label class="form-check-label">Door units <br> <input class="form-check-input" type="radio"
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label">Sliding doors <br> <input class="form-check-input" type="radio"
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label">Windows <br> <input class="form-check-input" type="radio"
                            name="sow[windows_and_entry_doors][timber_sliding_doors]" value="na"> N/A <span
                            class="text-success" style="font-size: 1.5em;"></span></label>
                </div>
            </div>
        ...
        <div class="font-italic small mt-3">
            <span class="font-weight-bold" style="font-style: normal;">Note:</span> Generally timber entry doors, door
            units
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][meranti_reveals]"
                        value="meranti">
                </div>
            </div>
        </div>
...
<div class="card pdf-card mb-3">
    ...
    <div class="card-body">
        ...
        <div class="font-italic small mt-3">
            <span class="font-weight-bold" style="font-style: normal;">Note:</span> Unless otherwise specified below,
            ALL
            windows and door unit glass will be clear glazed with the exception of WC's, Bathrooms and Ensuites which
            will
            be obscure glass.
        </div>
...
<div class="card pdf-card mb-3">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][security_door_sum]"
                        value="provisional">
...
<div class="card pdf-card mb-3">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][window_shutter_sum]"
                        value="provisional">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][other]" id="other"
                        value="other">
                    <label class="form-check-label" for="other">Other</label>
                    <input type="text" class="form-control form-control-sm w-75 border-0 border-bottom"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][motorised_openings]"
                        id="all_doors" value="all_doors" checked>
                    <label class="form-check-label" for="all_doors">All garage doors</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="sow[windows_and_entry_doors][motorised_openings]"
                        id="listed_doors" value="listed_doors">
