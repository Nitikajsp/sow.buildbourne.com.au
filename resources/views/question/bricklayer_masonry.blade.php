...
<div class="card pdf-card mb-3">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div class="radiobuttons-wrap">
            <label class="form-check-label me-3">As shown on plans
                <input class="form-check-input" type="radio"
                    name="sow[bricklayer_masonry][exterior_face_brickwork_plans]" value="as_shown_on_plans">

            </label>
            <label class="form-check-label">N/A
                <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][exterior_face_brickwork_na]"
                    value="na">
            </label>
        </div>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][face_brick_commons]"
                value="Commons_only">
            <label class="form-check-label">Commons only</label>
        </div>

        <div class="form-check">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][face_brick_selected]"
                value="Selected_bricks_Supplier">
            <label class="form-check-label">Selected bricks: Supplier</label>
            <input type="text" class="form-control mt-1 w-50" name="sow[bricklayer_masonry][supplier_name]"
        ...
        <div class="form-group mt-2">
            ...
            <input type="text" class="form-control w-50" name="sow[bricklayer_masonry][brick_name]" id="brick_name"
                placeholder="Enter Brick Name" value="">
        </div>

        <div class="form-group mt-2">
            <label for="blend">Blend:</label>
            <input type="text" class="form-control w-50" name="sow[bricklayer_masonry][blend]" id="blend"
                placeholder="Enter Blend" value="">
        </div>
        ...
        <div class="d-flex align-items-center">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][standard_laying_stretcher_bond]"
                value="standard_laying">
            <label class="form-check-label ms-2">Standard laying in stretcher bond</label>
            <span class="mx-2">OR</span>
            <input type="text" class="form-control w-50" name="sow[bricklayer_masonry][custom_laying_style]" value=""
        ...
        <div class="d-flex align-items-center">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][standard_sisalation_foil]"
                value="standard_sisalation">
            <label class="form-check-label ms-2">Standard sisalation foil (sarking) to exterior brick veneer cavity
                walls</label>
            <span class="mx-2">Other:</span>
            <input type="text" class="form-control w-50" name="sow[bricklayer_masonry][other_sisalation_foil]" value=""
        ...
        <div class="d-flex align-items-center mt-2">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][sills]"
                value="Single_brick_walls">
        ...
        <div class="d-flex align-items-center">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][brickwork_under_doors]"
                value="Under_doors_entry_and_laundry_doors ">
            <label class="form-check-label ms-2">Under doors, entry and laundry doors (generally tiled
                thresholds)</label>
            <span class="mx-2">OR</span>
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][mortar_colour]"
                value="Standard_natural_grey">
            <label class="form-check-label">Standard natural grey</label>
        </div>

        <div class="form-check">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][mortar_colour]"
                value="Standard_off_white">
            <label class="form-check-label">Standard off-white</label>
        </div>

        <div class="form-check">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][mortar_colour]"
                value="Oxide_coloured">
            <label class="form-check-label">Oxide coloured</label>
        </div>

        <div class="form-group mt-2">
            <label>Approx Colour:</label>
            <input type="text" class="form-control w-50" name="sow[bricklayer_masonry][approx_colour]"
                placeholder="Enter Approx Colour">
        </div>

        <div class="form-group mt-2">
            <label>Notes to above:</label>
            <input type="text" class="form-control w-50" name="sow[bricklayer_masonry][mortar_notes]"
        ...
        <div class="form-group mt-2">
            <label>Other:</label>
            <input type="text" class="form-control w-50" name="sow[bricklayer_masonry][other_joint]"
        ...
        <div class="form-check">
            ...
            <input type="text" class="form-control w-50" name="sow[bricklayer_masonry][na_description]"
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][feature_work]"
                value="Sandstone_capping_to_piers">
        ...
        <div class="form-group mt-2">
            ...
            <input type="text" class="form-control w-50" name="sow[bricklayer_masonry][supplier_sandstone]"
                id="supplier_sandstone" placeholder="Enter Supplier">
        </div>
        <div class="form-group mt-2">
            <label for="style_sandstone">Style:</label>
            <input type="text" class="form-control w-50" name="sow[bricklayer_masonry][style_sandstone]"
                id="style_sandstone" placeholder="Enter Style">
        </div>
        <div class="form-check">
        ...
        <div class="form-group mt-2">
            ...
            <input type="text" class="form-control w-50" name="sow[bricklayer_masonry][supplier_quoins]"
                id="supplier_quoins" placeholder="Enter Supplier">
        </div>
        <div class="form-group mt-2">
            <label for="style_quoins">Style:</label>
            <input type="text" class="form-control w-50" name="sow[bricklayer_masonry][style_quoins]" id="style_quoins"
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][feature_work]"
                value="Corbelling or other features">
            <label class="form-check-label">- Corbelling or other features as shown on plans and described as
                follows;</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][feature_work]" value="N/A">
        ...
        _built_into_brickwork_by_bricklayer_formed_using_brick_batts">
            <label class="form-check-label">- Standard vent built into brickwork by bricklayer formed using brick
                batts.</label><br>
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][sub_floor_vents]"
                value="Terracotta_or_coloured_precast_concrete">
            ...
            <input type="text" class="form-control w-50" name="sow[bricklayer_masonry][supplier_terracotta]"
                id="supplier_terracotta" placeholder="Enter Supplier">
            <label for="style_terracotta">Style:</label>
            <input type="text" class="form-control w-50" name="sow[bricklayer_masonry][style_terracotta]"
                id="style_terracotta" placeholder="Enter Style">
        </div>

        <div class="form-check">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][sub_floor_vents]"
                value="Fire_compliant_for_Fire_Risk_Areas">
            <label class="form-check-label">Fire compliant for Fire Risk Areas</label><br>
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][sub_floor_vents]" value="N/A">
            <label class="form-check-label">N/A</label><br>
            <label for="supplier_fire_compliant">Supplier:</label>
            <input type="text" class="form-control w-50" name="sow[bricklayer_masonry][supplier_fire_compliant]"
                id="supplier_fire_compliant" placeholder="Enter Supplier">
            <label for="style_fire_compliant">Style:</label>
            <input type="text" class="form-control w-50" name="sow[bricklayer_masonry][style_fire_compliant]"
                id="style_fire_compliant" placeholder="Enter Style">
        </div>
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][weep_holes]"
                value="Standard_weep_holes">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][weep_holes]"
                value="Fire_compliant_weep_holes_with_spark_arrester_inserts">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][brickwork_openings]"
                value="Galvanised_arch_bars_to_be_installed_over_square_arch_openings">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][brickwork_openings]"
                value="Curved_arch_openings_as_per_plans_Extra_Cost">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][brickwork_openings]"
                value="Standard_steel_door_jamb_to_single_brick_garage_P_A_door_opening">
        ...
        <div class="d-flex align-items-center">
            ...
            <input type="text" class="form-control form-control-sm w-75 border-0 border-bottom"
                name="sow[site_work][exterior_face_brickwork]" id="exterior_face_brickwork"
                placeholder="Enter exterior face brickwork notes">
        </div>
    </div>
</div>
...
<div class="card pdf-card mb-3">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5>6.2 Interior Feature Face Brickwork</h5>
        <div class="radiobuttons-wrap">

            <label class="me-3">As shown on plans <input class="form-check-input" type="radio"
                    name="sow[bricklayer_masonry][interior_feature_face_brickwork]" value="As_shown_on_plans"></label>
            <label class="me-3">N/A <input class="form-check-input" type="radio"
                    name="sow[bricklayer_masonry][interior_feature_face_brickwork]" value="N_A"></label>
        </div>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][face_brick_selections]"
                value="Commons_only">
...
<div class="card pdf-card mb-3">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5>6.3 Exterior Brickwork - "Bag Rendered"</h5>
        <div class="radiobuttons-wrap">
            <!-- radio for As Selected -->

            <label class="form-check-label">As Selected <input class="form-check-input" type="radio"
                    name="sow[bricklayer_masonry][bag_rendered_selection]" value="As_Selected"></label>


            <!-- radio for N/A -->

            <label class="form-check-label">N/A <input class="form-check-input" type="radio"
                    name="sow[bricklayer_masonry][bag_rendered_selection]" value="N/A"></label>
        </div>
    </div>
    <div class="card-body">
        <!-- Colour selection -->
...
<div class="card pdf-card mb-3">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5>6.4 Exterior Brickwork - "Skim Rendered"</h5>
        <div class="radiobuttons-wrap">
            <!-- radio for As Selected -->

            <label class="form-check-label">As Selected <input class="form-check-input" type="radio"
                    name="sow[bricklayer_masonry][skim_rendered_selection]" value="As_Selected"></label><br>

            <!-- radio for N/A -->

            <label class="form-check-label">N/A <input class="form-check-input" type="radio"
                    name="sow[bricklayer_masonry][skim_rendered_selection]" value="N/A"></label>
        </div>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="form-check">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][colour]"
                    id="colour_standard_natural_grey" value="Standard natural grey">
                <label class="form-check-label" for="colour_standard_natural_grey">Standard natural grey(Grey Portland
                    Cement, Brickies Sand & Mortar Additives)</label>
            </div>

            <!-- Standard off-white -->
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][colour]"
                    id="colour_standard_off_white" value="Standard off-white">
                <label class="form-check-label" for="colour_standard_off_white">Standard off-white(Off-White Portland
                    Cement, Off-White Sand & Mortar Additives. Note: Colour can vary depending on sand supplied)</label>
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][colour]"
                    id="colour_oxide_coloured" value="Oxide coloured">
                ...
                <small><strong></strong>(Sample mixed on site and approved by owner prior to laying bricks. Note: If
                    owner
                    cannot meet on site to approve colour then a guarantee of required colour cannot be given)</small>
...
<div class="card pdf-card mb-3">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5>6.5 Exterior Brickwork - "Full Render Coat Finish"</h5>
        <div class="radiobuttons-wrap">
            <!-- radio for As Selected -->
    ...
    <div class="card-body">
        <!-- Colour selection -->
        <div class="form-check">
            <label for="colour_standard_natural_grey">Standard natural grey(Grey Portland Cement, Brickies Sand & Mortar
                Additives)</label>
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][colour_standard_natural_grey]"
                value="Standard_natural_grey">
        </div>
        <small><strong>Note :</strong>A Render finish is applied by trowelling on a coat of sand and cement render mix
            to
            the brickwork approx, 10mm thick which is screeded plumb and straight then floated and sponged to even
            texture
            and finish. Generally this is then painted to a colour of choice.</small>

        <div class="d-flex align-items-center">
            <!-- Label and Input -->
            <label for="full_render_coat_finish" class="me-2 mb-0">Notes to above:</label>
            <input type="text" class="form-control form-control-sm w-75 border-0 border-bottom"
                name="sow[site_work][full_render_coat_finish]" id="full_render_coat_finish"
                placeholder="Enter full render coat finish notes">
        </div>
    </div>
</div>
...
<div class="card pdf-card mb-3">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5>6.6 Exterior Brickwork - "Other Coating Finish"</h5>
        <div class="radiobuttons-wrap">
            <!-- radio for As Selected -->

            <label class="form-check-label">As Selected <input class="form-check-input" type="radio"
                    name="sow[bricklayer_masonry][other_coating_finish_selection]" value="As_Selected"></label><br>

            <!-- radio for N/A -->

            <label class="form-check-label">N/A <input class="form-check-input" type="radio"
                    name="sow[bricklayer_masonry][other_coating_finish_selection]" value="N/A"></label>
        </div>
    </div>
    <div class="card-body">
        ...
        <div class="d-flex align-items-center">
            ...
            <input type="text" class="form-control form-control-sm w-75 border-0 border-bottom"
                name="sow[site_work][other_coating_finish]" id="other_coating_finish"
                placeholder="Enter other coating finish notes">
        </div>
    </div>
</div>
...
<div class="card pdf-card mb-3">
    ...
    <div class="card-body">
        ...
        <div class="form-check">
            ...
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][other_masonry_type]"
                value="Concrete_block_work">
            <label for="style">Concrete block work</label><br>

            <!-- Aerated Concrete radio -->
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][other_masonry_type]"
                value="Aerated_concrete_(Hebel)">
            <label for="style">Aerated concrete (Hebel)</label><br>

            <!-- Blue Board radio -->
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][other_masonry_type]"
                value="Blue_Board_(Fibre_Cement_Sheet_Acrylic_Rendered)">
            <label for="style">Blue Board (Fibre Cement Sheet Acrylic Rendered)</label><br>

            <!-- Foam Board radio -->
            <input class="form-check-input" type="radio" name="sow[bricklayer_masonry][other_masonry_type]"
                value="Foam_Board_(Foam_Board_Sheet_Acrylic_Rendered)">
