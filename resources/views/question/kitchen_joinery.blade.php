<div class="card p-3 mb-3">
    ...
    <div class="form-group row">
        <div class="col-sm-12">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sow[radio_and_joinery][radio_fixed_price]" id="radio_fixed_price" value="fixed" checked>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <input type="text" name="sow[radio_and_joinery][radio_manufacturer]" class="form-control" value="PRESTIGE">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sow[radio_and_joinery][radio_layout_plan]" id="radio_layout_yes" value="yes" checked>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <div class="form-check">
                <input class="form-check-input" type="radio" name="sow[radio_and_joinery][sink_supply_only]" id="sink_supply_only" value="supply_only" checked>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <div class="form-check">
                <input class="form-check-input" type="radio" name="sow[radio_and_joinery][range_hood_builder]" id="range_hood_builder" value="by_builder" checked>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sow[radio_and_joinery][range_hood_vented]" id="range_hood_vented" value="vented" checked>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sow[radio_and_joinery][bulkheads_required]" id="bulkheads_required_yes" value="yes" checked>
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sow[radio_and_joinery][bulkheads_by]" id="bulkheads_by_radio" value="radio" checked>
    ...
    <div class="form-group">
        ...
        <textarea name="sow[radio_and_joinery][radio_notes]" class="form-control">UNIT ONE BEIGE TONES UNIT TWO BLACK WHITE</textarea>
    </div>
</div>
...
<div class="card p-3 mb-3">
    ...
    <div class="form-group row">
        <div class="col-sm-12">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sow[radio_and_joinery][vanity_pc_selections]" id="vanity_pc_selections" value="pc_selections" checked>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <div class="form-check">
                <input class="form-check-input" type="radio" name="sow[radio_and_joinery][vanity_supply]" id="standard_vanity" value="standard" checked>
...
<div class="card p-3 mb-3">
    ...
    <div class="form-group row">
        <div class="col-sm-12">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sow[radio_and_joinery][laundry_pc_selections]" id="laundry_pc_selections" value="pc_selections" checked>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <div class="form-check">
                <input class="form-check-input" type="radio" name="sow[radio_and_joinery][tub_supply_builder]" id="tub_supply_builder" value="builder" checked>
...
<div class="card p-3 mb-3">
    ...
    <div class="form-group row">
        <div class="col-sm-12">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sow[radio_and_joinery][shelving_na]" id="shelving_na" value="na" checked>
...
<div class="card p-3 mb-3">
    ...
    <div class="form-group row">
        <div class="col-sm-12">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="sow[radio_and_joinery][staircase_selections]" id="staircase_selections" value="selections" checked>
