                                ...
                                <td class="d-flex justify-content-center align-items-center">
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <button class="btn btn-primary me-md-2 rounded set-btn set-btn-class"
                                            data-party-id="{{ $party->id }}" type="button">Set</button>
                                    </div>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end m-0">
                                            ...
                                            <form id="deletePartyForm"
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-party-id="{{ $party->id }}" data-bs-toggle="modal"
        ...
        <div class="modal-content border-0">
            <div class="modal-header border-0">
                ...
                <a href="{{ route('createlist', ['party_id' => $party->id]) }}"
                    class="btn btn-outline-dark text-dark rounded" id="createListLink">
